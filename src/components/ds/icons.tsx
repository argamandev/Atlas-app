...
function Base({ size = 20, strokeWidth = 1.6, children, ...rest }: IconProps & { children: React.ReactNode }) {
  return (
    <svg
      width={size}
      height={size}
...
export const HomeIcon = (p: IconProps) => (
  <Base {...p}><path d="M3 11.5l9-7.5 9 7.5" /><path d="M5 9.8V20h14V9.8" /></Base>
)
export const CalendarIcon = (p: IconProps) => (
  <Base {...p}><rect x="3.5" y="5" width="17" height="15" rx="2.5" /><path d="M3.5 9.5h17M8 3v4M16 3v4" /></Base>
)
export const SearchIcon = (p: IconProps) => (
  <Base {...p}><circle cx="11" cy="11" r="7" /><path d="M16.5 16.5L21 21" /></Base>
)
export const ChatIcon = (p: IconProps) => (
  <Base {...p}><path d="M5 5h14a1 1 0 011 1v8a1 1 0 01-1 1H9l-4 3v-3H5a1 1 0 01-1-1V6a1 1 0 011-1z" /></Base>
)
export const TopicsIcon = (p: IconProps) => (
  <Base {...p}><path d="M9.5 4L7.5 20M16.5 4l-2 16M5 9h14M4.5 15h14" /></Base>
)
export const SavedIcon = (p: IconProps) => (
  <Base {...p}><path d="M7 4h10v16l-5-3.6L7 20z" /></Base>
)
...
export const WatchlistsIcon = (p: IconProps) => (
  <Base {...p}><path d="M5 6h14M5 12h14M5 18h9" /><circle cx="18.5" cy="18" r="2.2" /></Base>
)
export const SettingsIcon = (p: IconProps) => (
  <Base {...p}><path d="M5 7h14M5 12h14M5 17h14" /><circle cx="9" cy="7" r="2" fill="currentColor" stroke="none" /><circle cx="15" cy="12" r="2" fill="currentColor" stroke="none" /><circle cx="8" cy="17" r="2" fill="currentColor" stroke="none" /></Base>
)
export const ProfileIcon = (p: IconProps) => (
  <Base {...p}><circle cx="12" cy="8" r="3.5" /><path d="M5 20c0-3.6 3.1-5.6 7-5.6s7 2 7 5.6" /></Base>
)
export const HelpIcon = (p: IconProps) => (
  <Base {...p}><circle cx="12" cy="12" r="8.5" /><path d="M9.5 9.5a2.5 2.5 0 113.2 2.4c-.7.3-1.2.9-1.2 1.6v.4" /><circle cx="11.5" cy="16.6" r="0.6" fill="currentColor" stroke="none" /></Base>
)
export const ReleaseNotesIcon = (p: IconProps) => (
  <Base {...p}><rect x="5" y="3.5" width="14" height="17" rx="2" /><path d="M8.5 8h7M8.5 12h7M8.5 16h4" /></Base>
)
...
export const AtIcon = (p: IconProps) => (
  <Base {...p}><circle cx="12" cy="12" r="3.6" /><path d="M15.6 12v1.6a2.4 2.4 0 004.8 0V12a8.4 8.4 0 10-3.2 6.6" /></Base>
)
export const SlashIcon = (p: IconProps) => (
  <Base {...p}><path d="M15 5L9 19" /></Base>
)
...
export const SparkleIcon = (p: IconProps) => (
  <Base {...p}><path d="M12 3.5l1.7 5 5 1.7-5 1.7L12 17l-1.7-5-5-1.7 5-1.7z" /><path d="M18.5 15.5l.7 2 2 .7-2 .7-.7 2-.7-2-2-.7 2-.7z" /></Base>
)
...
export const DotsVerticalIcon = (p: IconProps) => (
  <Base {...p}><circle cx="12" cy="5.5" r="1.4" fill="currentColor" stroke="none" /><circle cx="12" cy="12" r="1.4" fill="currentColor" stroke="none" /><circle cx="12" cy="18.5" r="1.4" fill="currentColor" stroke="none" /></Base>
)
export const FilterIcon = (p: IconProps) => (
  <Base {...p}><path d="M4 6h16l-6.2 7.6V19l-3.6-1.8v-3.6z" /></Base>
)
...
export const PlayIcon = (p: IconProps) => (
  <Base {...p}><path d="M8 5.5v13l11-6.5z" fill="currentColor" stroke="none" /></Base>
)
export const PauseIcon = (p: IconProps) => (
  <Base {...p}><rect x="7" y="5.5" width="3.4" height="13" rx="1" fill="currentColor" stroke="none" /><rect x="13.6" y="5.5" width="3.4" height="13" rx="1" fill="currentColor" stroke="none" /></Base>
)
export const VolumeIcon = (p: IconProps) => (
  <Base {...p}><path d="M4 9.5v5h3.2L12 18.5v-13L7.2 9.5z" /><path d="M15.5 9a4 4 0 010 6" /></Base>
)
// circular arrows used by rewind/forward; the "15" label is drawn by the player.
export const RewindCircleIcon = (p: IconProps) => (
  <Base {...p}><path d="M11 5a7 7 0 107 7" /><path d="M11 2.5L8 5l3 2.5" /></Base>
)
export const ForwardCircleIcon = (p: IconProps) => (
  <Base {...p}><path d="M13 5a7 7 0 11-7 7" /><path d="M13 2.5L16 5l-3 2.5" /></Base>
)
export const CaptionsIcon = (p: IconProps) => (
  <Base {...p}><rect x="3.5" y="6" width="17" height="12" rx="2.5" /><path d="M8 11.5a1.8 1.8 0 00-3 1.3 1.8 1.8 0 003 1.3M16 11.5a1.8 1.8 0 00-3 1.3 1.8 1.8 0 003 1.3" /></Base>
)
export const LevelsIcon = (p: IconProps) => (
  <Base {...p}><path d="M6 14v4M10 9v9M14 6v12M18 11v7" /></Base>
)
