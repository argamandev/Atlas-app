...
export const he: Dictionary = {
  ...
  chat: {
    ...
    // כרטיס 08b: היצמדות שהמנוע של הצ׳אט הזה אינו יודע לשאת. מחרוזת גלויה למשתמש,
    // ולכן היא ערך מילון — מחרוזת מפתחים זורמת ל-ErrorLine ומוצגת במקום שבו אמורה
    // להופיע תשובה בעברית.
    groundingUnsupported: 'הצ׳אט הזה עדיין לא יודע לקרוא עמודי דוח, גזירים או כתוביות חיות.',
