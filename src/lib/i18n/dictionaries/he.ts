...
export const he: Dictionary = {
  ...
  workspace: {
    ...
    intakeAdd: 'צירוף',
    intakeMic: 'הכתבה',
    intakeSearching: 'מחפש במה שיש לאטלס…',
    intakeFound: 'נמצאו {n}. הסירו סימון ממה שלא תרצו.',
    intakeNothingInPeriod: 'אין לי כלום עבור {company} מהתקופה הזו. הנה מה שכן יש:',
    intakeNoMatch: 'לא מצאתי באטלס שום דבר שתואם לזה עדיין.',
    ...
    intakeAdding: 'מוסיף לסביבת העבודה…',
