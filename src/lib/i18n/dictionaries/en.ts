...
export const en = {
  ...
  workspace: {
    ...
    emptyBody:
      'A workspace is one company or sector — its files, agents, and history, in one place.',
    ...
    notFoundHint:
      'Workspaces created in this demo live for the session only — a page reload clears them.',
    ...
    legalScopePlaceholder:
      'e.g. focus on the Haifa port concession and any change-of-control clauses…',
    legalRun: 'Run review',
