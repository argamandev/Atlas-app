...
gated by class G, the decided design passes). The frontier now: the **ingestion
standard** (16) and **MAYA filings at scale** (17). The spec (ticket 10) waits on
16/17 and closes the map.
