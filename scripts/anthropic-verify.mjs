...
// results file (NO secrets) to docs/archive/scratch/2026-08-13-smart-layer/research/11-key-verification.md.
...
// docs/archive/scratch/2026-08-13-smart-layer/research/02-agent-sdk.md §8 (Sonnet 5 bucket).
...
\`docs/archive/scratch/2026-08-13-smart-layer/research/02-agent-sdk.md\` §8. The founder-confirmed tier from the
