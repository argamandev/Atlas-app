...
- `ivrit-m1/` — Lane I Milestone 1 (2026-07): the task-8 quality-comparison report
  ...
  final-fixes report. Real-Zoom captures live in `scripts/out/sessions/2026-07-04-*`.
  Rescued from the Atlas-ivrit worktree 2026-07-14 (audit finding 4).
- Lane F design-parity (2026-07): founder gate ran live on :3001 2026-07-14 ("okay its
  good", DECISION line in cross-cutting) — the earlier walkthrough sheet existed only as a
  claude.ai artifact (audit finding 15, the failure class this folder now prevents).
