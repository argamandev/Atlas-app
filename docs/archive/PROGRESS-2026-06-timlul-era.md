# PROGRESS archive — 2026-06-07 → 2026-06-27: the Timlul/V1 era

> Raw decision-log entries compacted out of PROGRESS.md on 2026-07-03 (fleet-lint check 8,
> founder-approved). The distilled era summary — every decision still in force, dead ends,
> and carried tech debt — lives at the bottom of PROGRESS.md. Nothing was edited here;
> these are the original entries verbatim, newest first.
