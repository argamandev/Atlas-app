...
(`archive/scratch/smart-layer-map-2026-08/research/07-retrieval-eval-results.md`), the architecture
(ticket 08), and the MAYA structured-data facts
(`archive/scratch/smart-layer-map-2026-08/research/14-maya-structured-data.md`).
